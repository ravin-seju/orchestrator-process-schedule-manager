...
describe('stress tenant fixtures', () => {
  it('parses stress tenant shortcuts and creates matching fixture counts', () => {
    ...
    expect(createStressScheduleData(5).schedules).toHaveLength(5)
    expect(createStressScheduleData(10).schedules).toHaveLength(10)
    expect(createStressScheduleData(50).schedules).toHaveLength(50)
    expect(createStressScheduleData(100).schedules).toHaveLength(100)
  })
})
